...
/*   Updated: 2022/06/01 12:29:44 by hde-min          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include "so_long.h"
...
void	ft_init_object(t_vars *vars)
{
	...
	o = vars->o;
	o[0].p = "Images/door.xpm/door.xpm";
	o[1].p = "Images/mouse.xpm/mouse.xpm";
	o[2].p = "Images/tronc.xpm/tronc1.xpm";
	o[3].p = "Images/tronc.xpm/tronc2.xpm";
	i = -1;
	while (++i < 4)
	{
		o[i].x = 64;
...
void	ft_init_image(t_vars *vars)
{
	...
	vars->g = malloc(sizeof(t_img) * 4);
	vars->o = malloc(sizeof(t_img) * 4);
	ft_init_cat(vars);
	ft_init_fence(vars);
	ft_init_ground(vars);
	ft_init_object(vars);
